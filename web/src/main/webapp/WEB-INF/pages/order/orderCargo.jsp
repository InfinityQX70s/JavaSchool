...
<div class="row z-depth-2" id="readroot">
    <div class="row">
        <a class="secondary-content disabled right-align"
...
<div class="row right-align">
    <a class="btn-floating btn-tiny waves-effect waves-light blue lighten-1 accent-2" onclick="moreFields()"><i
