        ...
        <div class="card-panel">
          <span>
            ...
            <div class="row center" style="margin-top:30px;">
                <a href="/logout" class="waves-effect waves-light btn light-blue accent-999 light-blue-text text-accent-999"><i class="material-icons left">arrow_back</i>Logout</a>
            </div>
        </div>
    </div>
</div>
