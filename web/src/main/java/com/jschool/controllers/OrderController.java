...
public class OrderController {
    ...
    public String addOrder(HttpServletRequest req, Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            switch (stepNumber) {
                ...
                default:
                    redirectAttributes.addFlashAttribute("message", "Wrong step number");
                    return "redirect:/employee/orders";
            }
        } catch (ServiceException e) {
            LOG.warn(e);
    ...
    public
    @ResponseBody
    JsonResponse submitOrder(HttpServletRequest req, Model model) throws IOException {
        try {
